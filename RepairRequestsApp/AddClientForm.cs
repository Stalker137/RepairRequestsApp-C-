...
namespace RepairRequestsApp
{
    public partial class AddClientForm : Form
    {
        ...
        public AddClientForm() : this(0, 0)
        {
            InitializeComponent();
        }


        public AddClientForm(int userID, int roleID) : this(userID, roleID, null)
        {
            InitializeComponent();
        }

        public AddClientForm(int userID, int roleID, int? clientID) : base()
        {
            InitializeComponent();
            this.userID = userID;
            this.roleID = roleID;
